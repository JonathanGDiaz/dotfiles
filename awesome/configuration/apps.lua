...
return {
	...
	default = {
		...
		--- Default text editor
		text_editor = "wezterm start /jonathan/home/.local/bin/lvim",
		--- Default code editor
		code_editor = "code",
		--- Default web browser
		web_browser = "firefox",
	...
	utils = {
		...
		full_screenshot = "flameshot full --path /home/jonathan/Pictures/Screenshots",
		--- Area screenshot
		area_screenshot = "flameshot gui",
		--- Keyboard changer
		keyboard_changer = utils_dir .. "keyboard.sh",
	},
}
